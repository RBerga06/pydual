...
from .abc import Callback1Scalar, Callback1Vector, Callback2, DualBasis, DualPart, Callback1
...
class DynDualPart[S: Shape](DualPart[DynDualBasis, S]):
    ...
    @staticmethod
    def from_dual_parts[Z: Shape](*duals: DualPart[DualBasis, Z]) -> "DynDualPart[Z]":
